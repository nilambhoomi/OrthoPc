        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        txtROS.Text = "Temperature taken at the time of exam was ___ degrees Fahrenheit.<br/><b>General:</b> No fever, chills, night sweats, weight gain, or weight loss. <br/>" +
                "               <b>HEENT:</b> No double vision, eye pain, eye redness, decreased hearing, earache, ear ringing, nosebleeds, sore throat or hoarseness.<br/>" +
                "<b>Endocrine:</b> No cold intolerance, appetite changes or hair changes. <br/>" +
                "               <b>Skin:</b> Clear, no rashes or lesions<br/>" +
                "<b>Neuro:</b> No headaches, dizziness, vertigo or tremor.<br/>" +
                "               <b>Respiratory:</b> No wheezing, coughing, shortness of breath or difficulty breathing.<br/>" +
                "<b>Cardiovascular:</b> No chest pain, murmurs, irregular heart rate or hypertension.<br/>" +
                "               <b>GI:</b> No nausea, vomiting, diarrhea, constipation, jaundice or changes in bowel habits.<br/>" +
                  "<b>GU:</b> No blood in urine, painful urination, loss of bladder control or urinary retention.<br/>" +
                  "<b>Hematology:</b> No active bleeding, bruising, anemia or blood clotting disorders.<br/>" +
                "               <b>Psychiatric:</b> No anxiety, change in sleep pattern, depression or suicidal thoughts.<br/>";
                ...
                {
                    bindHtml();
                    txtROS.Text = "Temperature taken at the time of exam was ___ degrees Fahrenheit<br/><b>General:</b> No fever, chills, night sweats, weight gain, or weight loss. <br/><br/>" +
