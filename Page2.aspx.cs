...
public partial class Page2 : System.Web.UI.Page
{
    ...
    public void bindHtml()
    {
        ...
        DataSet ds = new DBHelperClass().selectData("select Sex,Age,DOA,Handedness from View_PatientIE where PatientIE_ID=" + Session["PatientIE_ID"].ToString());
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (!string.IsNullOrEmpty(handness))
            {
                if (handness == "right-handed")
                    handness = "right-hand";
                else
                    handness = "left-hand";
            }
