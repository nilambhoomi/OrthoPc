                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <a href='<%# "https://docs.google.com/viewer?url=https://www.paintrax.com/ORTHOPC"+Eval("path").ToString().Replace("~","")+"&embedded=true" %>' target="_new" class="btn btn-info">Preview </a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
