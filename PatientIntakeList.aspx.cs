...
public partial class PatientIntakeList : System.Web.UI.Page
{
    ...
    protected void lnkprint_Click(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(strBodypart))
        {
            ...
            str = str.Replace("#CC1", sb.ToString() + " pain.");
        }
        else
        {
            str = str.Replace("#CC1", "");
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            str = str.Replace("#location", ds.Tables[0].Rows[0]["Location"].ToString() + "<br/>" + ds.Tables[0].Rows[0]["Address"].ToString() + "<br/>" + ds.Tables[0].Rows[0]["City"].ToString() + ", " + ds.Tables[0].Rows[0]["State"].ToString() + " " + ds.Tables[0].Rows[0]["Zip"].ToString());
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            str = str.Replace("#socialhistory", "<b>SOCIAL HISTORY: </b>" + strstatus.TrimEnd('.').Replace(" .", "") + "<br/><br/>");
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["DiagCervialBulgeDate"].ToString()))
            {
                ...
                strDaignosis = strDaignosis + " Cervical spine, done on " + Convert.ToDateTime(ds.Tables[0].Rows[0]["DiagCervialBulgeDate"].ToString()).ToString("MM/dd/yyyy") + ", shows " + ds.Tables[0].Rows[0]["DiagCervialBulgeText"].ToString().ToLower() + ",";
            ...
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["DiagThoracicBulgeDate"].ToString()))
            {
                ...
                strDaignosis = strDaignosis + " Thoracic spine, done on " + Convert.ToDateTime(ds.Tables[0].Rows[0]["DiagThoracicBulgeDate"].ToString()).ToString("MM/dd/yyyy") + ", shows " + ds.Tables[0].Rows[0]["DiagThoracicBulgeText"].ToString().ToLower() + ", ";
            ...
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["DiagLumberBulgeDate"].ToString()))
            {
                ...
                strDaignosis = strDaignosis + " Lumbar spine, done on " + Convert.ToDateTime(ds.Tables[0].Rows[0]["DiagLumberBulgeDate"].ToString()).ToString("MM/dd/yyyy") + ", shows " + ds.Tables[0].Rows[0]["DiagLumberBulgeText"].ToString().ToLower() + ", ";
            ...
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["DiagRightShoulderDate"].ToString()))
            {
                ...
                strDaignosis = strDaignosis + " right shoulder, done on " + Convert.ToDateTime(ds.Tables[0].Rows[0]["DiagRightShoulderDate"].ToString()).ToString("MM/dd/yyyy") + ", shows " + ds.Tables[0].Rows[0]["DiagRightShoulderText"].ToString().TrimEnd('.').ToLower() + ". ";
            ...
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["DiagLeftShoulderDate"].ToString()))
            {
                ...
                strDaignosis = strDaignosis + " left shoulder, done on " + Convert.ToDateTime(ds.Tables[0].Rows[0]["DiagLeftShoulderDate"].ToString()).ToString("MM/dd/yyyy") + ", shows " + ds.Tables[0].Rows[0]["DiagLeftShoulderText"].ToString().TrimEnd('.').ToLower() + ". ";
            ...
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["DiagRightKneeDate"].ToString()))
            {
                ...
                strDaignosis = strDaignosis + " right knee, done on " + Convert.ToDateTime(ds.Tables[0].Rows[0]["DiagRightKneeDate"].ToString()).ToString("MM/dd/yyyy") + ", shows " + ds.Tables[0].Rows[0]["DiagRightKneeText"].ToString().TrimEnd('.').ToLower() + ". ";
            ...
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["DiagLeftKneeDate"].ToString()))
            {
                ...
                strDaignosis = strDaignosis + " left knee, done on " + Convert.ToDateTime(ds.Tables[0].Rows[0]["DiagLeftKneeDate"].ToString()).ToString("MM/dd/yyyy") + ", shows " + ds.Tables[0].Rows[0]["DiagLeftKneeText"].ToString().TrimEnd('.').ToLower() + ". ";
            ...
            if (!string.IsNullOrEmpty(strDaignosis))
                str = str.Replace("#diagnostic", "<b>DIAGNOSTIC TESTING:</b> " + strDaignosis + "<br/><br/>");
            else
        ...
        if (!string.IsNullOrEmpty(strDaignosis))
        {
            ...
            str = str.Replace("#diagnoses", "<b>ASSESSMENT: </b>" + strDaignosis + "<br/><br/>");
        }
        else
    ...
    public string printPage1(string patientIE_ID)
    {
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            //if (!string.IsNullOrEmpty(strBodypart))
            //    str = str.Replace("#sustained", " #gender sustained multiple skeletal injuries including injury to " + strBodypart.TrimStart(',') + ". ");
    ...
    protected void lnkprintFU_Click(object sender, EventArgs e)
    {
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["DiagLumberBulgeDate"].ToString()))
            {
                ...
                if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["DiagLumberBulgeText"].ToString()))
                    strDaignosis = strDaignosis + " Lumbar spine bulge at " + ds.Tables[0].Rows[0]["DiagLumberBulgeText"].ToString() + ", ";
                ...
                if (!string.IsNullOrEmpty(str[i]))
                {
                    ...
                    else
                    {
                        if (string.IsNullOrEmpty(strVal))
                            strVal = "<li>" + str[i].TrimStart('@') + "</li>";
                        else
                            strVal = strVal + "<li>" + str[i].TrimStart('@') + "</li>";
                    }
                }
            }
