...
public partial class ProcedureSurgeryReport : System.Web.UI.Page
{
    ...
    protected void BindProcudureList()
    {
        ...
        query += ", CASE when tp.MC_TYPE='Yes' then ISnull(tp.MC_Report_Status,'Received') ELSE 'Received' end as MC_Status ";
        ...
        query += ", CASE when tp.IsVaccinated=1 then ISNULL(tp.Vac_Status,'') else 'Received' end as 'Vac_Status'  ";
